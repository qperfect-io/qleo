...
<<<<<<< HEAD
||||||| parent of 0830d1f (Devel (#8))
If you encounter any errors or bugs while using QLEO, please report them by opening an issue in the QLEO repository [here](https://github.com/qperfect-io/qleo/issues).
